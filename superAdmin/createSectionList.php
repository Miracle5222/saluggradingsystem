                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">
                                    <!-- <h3 align="center">Select Section to View Pupils</h3> -->
                                </strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ORDER BY tbllevel.levelName ASC");
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="studentList3.php?departmentId=<?php echo $row['departmentId']; ?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a></td>
                                                                </tr>
                                                            <?php
